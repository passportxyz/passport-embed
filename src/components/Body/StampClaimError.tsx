...
const BackToStampsIcon = () => (
  <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <g clipPath="url(#clip0_stamp_error)">
...
interface StampClaimErrorProps {
  platform: Platform;
  onBack: () => void;
}
  ...
  return (
    <>
      <div className={styles.textBlock}>
        <div className={`${styles.heading} ${styles.textCenter}`}>Verification Failed</div>
        <div className={styles.textCenter}>
          Unable to verify {platform.name}. Please try again.
        </div>
      </div>
