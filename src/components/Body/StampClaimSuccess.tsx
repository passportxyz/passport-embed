      ...
      <div className={styles.textBlock}>
        ...
        <div className={styles.stampSuccessHeader}>
          <div className={styles.stampSuccessPlatform}>
            ...
            <span className={styles.stampSuccessPlatformName}>{platform.name}</span>
          </div>
          <div className={styles.stampSuccessPoints}>
        ...
        <div className={styles.textCenter}>
          You've verified credentials within<br />the {platform.name} Stamp
        </div>
      </div>

      {/* Back to Stamps button */}
      <Button onClick={onBack} className={`${utilStyles.wFull} ${styles.stampSuccessButton}`}>
        <div className={styles.buttonContent}>
          <BackToStampsIcon />
          <span style={{ marginLeft: '8px' }}>Back to Stamps</span>
        </div>
      </Button>
    </>
  );
